...
function yourpropfirm_display_custom_field_after_billing_form() {
    ...
    if ($checkout_form === ' yourpropfirm_form') {
        ?>
        <div class="yourpropfirm_mt_version yourpropfirm_mt_version_field_wrapper">
            <?php
             yourpropfirm_form_field('yourpropfirm_mt_version', array(
                'type' => 'select',
...
add_action(' yourpropfirm_after_checkout_billing_form', 'yourpropfirm_display_custom_field_after_billing_form');

add_action(' yourpropfirm_checkout_process', 'yourpropfirm_validate_mt_version_field');
